...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader('D:\Works\SLM melt pool\melt pool 實拍\0624\spatter\300W_600mms.avi');
        ...
        obj.detector = vision.ForegroundDetector('NumGaussians', 5, ...
            'NumTrainingFrames', 20, 'MinimumBackgroundRatio', 0);
...
% remove noisy pixels and to fill the holes in the remaining blobs.  
    ...
    function [centroids, bboxes, mask] = detectObjects(frame)
        ...
        % Detect foreground.
        mask = obj.detector.step(frame);% mask為2元影像，1為物體，0為背景
